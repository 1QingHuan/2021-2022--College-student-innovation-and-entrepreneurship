...
def get_mnist_test_npy(path):
    data = np.load('C:/Users/86195/Desktop/newDesign/Design/deepgauge/mnist.npz')
    ...
    print(data['y_test'])
    filename = get_imlist(r"C:/Users/86195/Desktop/newDesign/Design/deepgauge/mnist_data/size_200/0/")
    class_name = path[-2:-1]
